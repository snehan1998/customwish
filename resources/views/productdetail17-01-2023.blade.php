    ...
    <div class="row">
        ...
        $('.add-to-varcartt1<?php echo $product->id; ?>').click(function(e){
            ...
            $.ajax({
                ...
                "buttonid":buttonid,"colortype":colortype,"printside":printside,"charm_id":charm_id,"addtext2":addtext2,"addtext1":addtext1,"logoupload":logoupload,"imageupload":imageupload,"quantity":quantity,"eggtype":eggtype,"a":a},
                dataType: "json",
                success: function (response) {
...
?>
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
        <button type = "button" class = "logbtn add-to-procartt11test{{$product->id}}"  style="background: #f2f2f2; color: black;  border: none;width: 100%;">ADD TO CART</button>
        </div>
        <div class="col-lg-6">
          <button type = "button" class = "logbtn" style="width: 100%; ">BUY NOW</button>
          </div>
