...
<body>
  ...
  <div class="shop-ccc">
    <h1 class="shopping-crt">Order Details</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-9">
        		...
        		<div><div class="card-box">
                    ...
                    <div class="d-flex flex-row-reverse bg-dark grand_total p-3">
        ...
        <div class="text-center mb-3"><button class="btn btn-danger btn-sm mx-auto w-50 mt-3" type="button" onclick="window.print()">Print</button></div>
