        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">{{$child->childcat_name}}</span>
                </nav>
            </div>
        </div>
    </div>
...
<!----------------------------------------------Filter Start ------------------------------------------------>
    <article class="vendors-filter">
        <div class="container">
           ...
           <a data-toggle="collapse" href="#top-filter" role="button" aria-expanded="false" aria-controls="top-filter" id="sidebarCollapse">
...
$("button").click(function() {
    ...
    if ($(this).val() != "") {
        ...
        location.href = "{{route('products.productindex', $child->id)}}";
    }
