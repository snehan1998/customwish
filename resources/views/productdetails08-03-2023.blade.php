    ...
    <div class="row align-items-start">
    	...
    	<div class = "col-lg-7 product-content">
            ...
            <?php  $procombopart = App\Models\ProductCombo::where('product_id',$product->id)->get();?>
                ...
                <div class="showonlyclick{{$procombopart->id}}" style="display: none;"  id="buttonattr{{$procombopart->id}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <p class="pflex">
                                <select class="form-select inputclass12 charm_id{{$product->id}}" data-comboattrr="{{$optionheading->combo_id}}" onclick="getcharmid(); getchamprice();gettotal();" id="charm_idd" aria-label="Default select example" name="charm_id" style="color: gray;">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <p class="pflex">
                        <select class="form-select inputclass12 charm_id{{$product->id}}" onclick="getcharmid(); getchamprice();gettotal();" id="charm_idd" aria-label="Default select example" name="charm_id" style="color: gray;">
            ...
            <div class="row">
                @if($product->datee == 1)
                <div class="col-lg-6">
                    <input type="text" id="datepickerr" name="datee" class="datecss datee{{$product->id}}" placeholder="Select Delivery Date">
                </div>
                @endif
                @if($product->timee == 1)
                <div class="col-lg-6">
            ...
            <div class="col-lg-10">
                <div class="input-group-append1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control location{{$product->id}}" value="" id="location" name="location" placeholder="Pincode/Location (only Bangalore)" style="color:#000!important;">
        ...
        $.ajax({
            ...
            success: function (dataa) {
               $.each(dataa, function(key,value) {
                $("#price-dd").append('<input type="hidden" class="price'+value.product_id+'" class="pricee-dd" name="price" id="price-dd" value="'+ value.price+'" >');
