...
<table border="1" cellspacing="1" cellpadding="5">
    <tr>
        ...
        <td>Mobile No</td><td>:</td><td>{{$mobile}}</td>
          ...
          <tr>
        <td>Experience</td><td>:</td><td>{{$experience}}</td>
        </tr>
        <tr>
        <td>Position</td><td>:</td><td>{{$position}}</td>
        </tr>
        <tr>
		<td>Resume</td><td>:</td><td><a href="http://127.0.0.1:8000/public/uploads/pdf/{{$profileresume}}" download>Click here to download the resume</a></td>
		</tr>
        <tr>
