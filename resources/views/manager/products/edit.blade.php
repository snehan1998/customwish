            ...
            <div class="card-body">
                <div class="form-validation">
                    <form method="get" action="">
                      ...
                      <form method="post" action="{{ route('manager.products.update',$data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <input type="hidden" id="id" value="{{$data->id}}">
                         ...
                         <form enctype="multipart/form-data" method="post" action="{{url('manager/products/addflower')}}">
                            @csrf
                        ...
                        <h3>Update Flower</h3>
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <form id="resource-delete-{{ $treat->id }}" action="{{ url('manager/products/flowerdelete') }}?id={{$treat->id}}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                    @csrf
                                    </form></td>
                                </tr>
                                @endforeach
                            ...
                            <form enctype="multipart/form-data" method="post" action="{{url('manager/products/addmorebuttons')}}">
                                @csrf
                                <input type="hidden" name="product_id" value="{{$data->id}}">
                                <h3>Add </h3>
                                <div class="form-group">
                            ...
                            <h3>Update Button</h3>
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <form id="resource-delete-{{ $butt->id }}" action="{{ url('manager/products/buttondelete') }}?id={{$butt->id}}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                        @csrf
                                        </form></td>
                                    </tr>
                                    @endforeach
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <form enctype="multipart/form-data" method="post" action="{{url('manager/products/addMoreImages')}}">
                      @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                          ...
                          <div>
                           <form action="{{url('manager/products/delete-multiple-image')}}?id={{$row->id}}" id="resource-delete-{{ $row->id }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                            @csrf
                           </form>
                          </div>
                          <div>
