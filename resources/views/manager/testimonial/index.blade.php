                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/manager/testimonial/create') }}" class="btn btn-primary btn-sm scroll-click"> create</a>
                                </div>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td  width="250px"><img src="{{ asset('uploads/images/') }}/{{ @$row->image1 }}" style="width: 30%;" /></td>
                                                <td>{{@$row->name}}</td>
                                                <td>{{$row->designation}}</td>
                                                <td class="color-primary"><a href="{{ route('manager.testimonial.edit', $row->id) }}" class="btn btn-primary"><i class="fa fa fa-pencil m-0"></i></a>
                                                ...
                                                <form id="resource-delete-{{ $row->id }}"
                                                    action="{{ route('manager.testimonial.destroy', $row->id) }}"
