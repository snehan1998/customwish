                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="text-right">
                            <a href="{{ route('manager.banners.create') }}" class="btn btn-primary btn-sm scroll-click" >create</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <!-- <td>{{ @$row->banner_url }}</td>-->
                                        ...
                                        <td>
                                    <a href="{{ route('manager.banners.edit', $row->id) }}" class="btn btn-primary">Edit</a>
                                    <button form="resource-delete-{{ $row->id }}" class="btn btn-danger btn-icon-style-2"><span>Delete</span></button>
                                    <form id="resource-delete-{{ $row->id }}" action="{{ route('manager.banners.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                    @csrf
                                    @method('DELETE')
                                    </form> </td>
                                    </tr>
