                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/manager/banners/') }}" class="btn btn-primary btn-sm scroll-click">View Banner</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('manager.banners.update', $data->id) }}">
                                @csrf
                                @method('PATCH')
