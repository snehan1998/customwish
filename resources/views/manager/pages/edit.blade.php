                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/manager/pages/') }}" class="btn btn-primary btn-sm scroll-click">View Coupons</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('manager.pages.update', $data->id) }}">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-md-12">
