                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/manager/productselectoption/') }}" class="btn btn-primary btn-sm scroll-click">View </a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    @endif
                                <form role="form" id="myform" method="post" action="{{ route('manager.productselectoption.update', $data->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                    <div class="row">
                                        <div class="col-xl-12">
                            ...
                            <form enctype="multipart/form-data" method="post" action="{{url('manager/productselectoption/addMoreselection')}}">
                                @csrf
                                <input type="hidden" name="product_id" value="{{$data->product_id}}">
                                <input type="hidden" name="combo_id" value="{{$data->combo_id}}">
                            ...
                            <h3>Update Selection Option</h3>
                                ...
                                <tbody>
                                    ...
                                    <td><button form="resource-delete-{{ $serv->id }}" class="btn btn-danger">Delete</button>
                                        <form id="resource-delete-{{ $serv->id }}" action="{{ url('manager/productselectoption/deleteselection') }}?id={{$serv->id}}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                        @csrf
                                        </form></td>
                                    </tr>
