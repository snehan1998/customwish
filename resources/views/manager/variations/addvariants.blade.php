	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ url('/manager/variations/addvariant') }}/{{$findpro->id}}" method="POST">
					{{ csrf_field() }}
...
<div id="edit{{ $optt->id }}" class="delete-modal modal fade" role="dialog">
  <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="{{ url('manager/variations/update/variant')}}/{{$optt->id}}" method="POST">
                  {{ csrf_field() }}
...
<p>
<form enctype="multipart/form-data" action="{{ url('/manager/variations/product') }}" method="POST">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td><a class="dropdown-item"
                                        href="{{ url('/manager/variations/variationedit', $subva->id) }}"><i
                                        ...
                                        <form id="resource-delete-{{ $subva->id }}"
                                            action="{{ url('/manager/variations/variationdestroy', $subva->id) }}"
    ...
    $('#attr_name').on('change', function () {
       ...
       // alert(get);
        ...
        $.ajax({
          ...
          data: "sendval=" + get,
          datatype: "json",
          url: baseUrl + "/manager/variations/get/productvalues",
