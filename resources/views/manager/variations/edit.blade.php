...
<!-----------------------------Add Variations--------------------------------------------------->
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('manager.variations.update',$data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <form enctype="multipart/form-data" method="post" action="{{url('manager/variations/addMoreImagesvar')}}">
                      @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                          ...
                          <div>
                           <form action="{{url('manager/variations/delete-multiplevar-image')}}?id={{$row->id}}" id="resource-delete-{{ $row->id }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                            @csrf
                           </form>
                          </div>
                          <div>
