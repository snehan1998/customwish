                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/admin/corporate/') }}" class="btn btn-primary btn-sm scroll-click">View Corporate Products</a>
                                </div>
                            </div>
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form method="get" action="">
                      ...
                      <form method="post" action="{{ route('admin.corporate.update',$data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <form enctype="multipart/form-data" method="post" action="{{url('admin/corporate/addcorporateImages')}}">
                      @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                          ...
                          <div>
                           <form action="{{url('admin/corporate/corporatedeleteimage')}}?id={{$row->id}}" id="resource-delete-{{ $row->id }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                            @csrf
                           </form>
                          </div>
                          <div>
