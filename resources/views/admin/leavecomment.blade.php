                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> @if($row->status == "Active") Active @endif @if($row->status == "Inactive") Inactive @endif
                                            ...
                                            <form id="resource-delete-{{ $row->id }}" action="{{url('/admin/leavecommentdestroy')}}/{{$row->id}}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                            @csrf
                                            @method('DELETE')
                                            </form>
                                        </td>
