                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/admin/section8/') }}" class="btn btn-primary btn-sm scroll-click">View Section8</a>
                                </div>
                            </div>

                            <div class="card-body">
                                <div class="form-validation">
                                <form role="form" id="myform" method="post" action="{{ route('admin.section8.update', $data->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                    <div class="row">
                                        <div class="col-xl-12">
                                             <div class="form-group">
                                                <label for="price">Name </label><span class="text-danger">*</span>
                                                    <input type="text" name="section_name" required id="section_name" class="form-control" placeholder="Enter Name" value="{{ $data->section_name }}" />
                                              ...
                                              <div class="form-group">
                                                <label>Image</label>
                                                <img src="{{ URL::asset('/')}}uploads/images/{{$data->section_image }}"  style="width: 5%;" accept="image/*" >
