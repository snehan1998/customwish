            ...
            <div class="row">
                <div class="col-12">
                        <div class="card">
                            ...
                            <a href="{{ route('admin.blogcategory.create') }}" data-toggle="modal" data-target="#addRowModal"
            ...
            <div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form enctype="multipart/form-data"  method="post" action="{{ route('admin.blogcategory.store') }}">
                                    @csrf
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.blogcategory.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        ...
                                        <div class="modal fade" id="addRowModal{{$row->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form enctype="multipart/form-data"  method="post" action="{{ route('admin.blogcategory.update',$row->id) }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="modal-body">
