                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{ url('/admin/productselectoption/') }}" class="btn btn-primary btn-sm scroll-click">View Product Select Option</a>
                                </div>
                            </div>
                            ...
                            <form role="form" id="myform" method="post" action="{{ route('admin.productselectoption.store') }}"
