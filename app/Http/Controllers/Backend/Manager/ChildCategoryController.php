...
class ChildCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.childcategory.index', compact('data'));
    }
   ...
   //   $sub = SubCategory::where('status', 'Active')->get();
        ...
        return view('manager.childcategory.create', compact('firstcategory','subcategory_id','category','subcategory'));
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        return view('manager.childcategory.edit', compact('data', 'data1','data2','firstcategory','subcategory','category'));
    }
