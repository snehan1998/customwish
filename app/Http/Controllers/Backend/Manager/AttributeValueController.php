...
class AttributeValueController extends Controller
{
    ...
    public function index()
    {
          ...
          return View('manager.attributevalue.index',compact('data'));
    }
    ...
    public function create($id)
    {
          ...
          return View('manager.attributevalue.create',compact('attr','data'));
    }
    ...
    public function edit($id)
    {
          ...
          return View('manager.attributevalue.edit');
    }
