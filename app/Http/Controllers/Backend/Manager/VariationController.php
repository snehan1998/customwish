...
class VariationController extends Controller
{
    ...
    public function addvariants(Request $request,$id){
       ...
       //return $getopts;
        return view('manager.variations.addvariants',compact('findpro','getopts','sub_variant','sub_variantt','getoptss','getoptsss'));
    }
    ...
    public function create($id)
    {
        ...
        return view('manager.variations.create', compact('provarit','idd','data','var','varr','productb'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.variations.edit', compact('provarit','idd','data','var','varr','item_val_ids','images','productb'));
