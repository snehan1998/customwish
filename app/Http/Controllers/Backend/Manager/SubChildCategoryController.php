...
class SubChildCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.subchildcategory.index', compact('data'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('manager.subchildcategory.create', compact('firstcategory','maincategory','subcategory','childcategory'));
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        return view('manager.subchildcategory.edit', compact('data', 'data1','data2','data3','firstcategory','maincategory','subcategory','childcategory'));
    }
