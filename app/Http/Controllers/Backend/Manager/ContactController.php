...
class ContactController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('manager.contact.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->opening_hour = $request->opening_hour;
