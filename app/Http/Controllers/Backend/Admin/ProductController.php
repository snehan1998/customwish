...
class ProductController extends Controller
{
    ...
    public function create(Request $request)
    {
      ...
      //  }
            $childcategory;
        return view('admin.products.create',compact('childcategory','subcategory','firstcategory','maincategory','subchildcategory'));
    }
   ...
   /**
    ...
    public function edit($id,Request $request)
    {
      ...
      //      $subcategory = Subcategory::where('status','Active')->where('category_id',$data->category_id)->get();
      //  }
        return View('admin.products.edit',compact('proreq','cake_desc','butt','childcategory','treat','maincategory','item_attr_ids','firstcategory','data','subcategory','item_rel_ids','images','subchildcategory','item_attr_idsc'));
    }
