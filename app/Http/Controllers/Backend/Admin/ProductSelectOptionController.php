...
class ProductSelectOptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.productselectoption.index',compact('data'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.productselectoption.create',compact('products','combo','firstcategory'));
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        return view('admin.productselectoption.edit',compact('data','products','service','combo','check'));
    }
